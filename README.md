...
* [Bugs](https://github.com/Stremio/stremio-bugs) ⭐ 164 | 🐛 444 | 📅 2026-06-28
* [Feature requests](https://github.com/Stremio/stremio-features) ⭐ 164 | 🐛 595 | 📅 2026-04-22
...
* [Stremio Web](https://github.com/stremio/stremio-web) ⭐ 13,907 | 🐛 70 | 🌐 JavaScript | 📅 2026-09-16
* [Stremio Core](https://github.com/Stremio/stremio-core/tree/development) ⭐ 2,406 | 🐛 82 | 🌐 Rust | 📅 2026-09-16
* [Addon SDK](https://github.com/Stremio/stremio-addon-sdk) ⭐ 1,361 | 🐛 80 | 🌐 JavaScript | 📅 2026-04-08
...
* [PimpMyStremio (aka "PMS")](https://github.com/sungshon/PimpMyStremio) ⭐ 502 | 🐛 37 | 🌐 JavaScript | 📅 2023-10-25: Local addon manager for Stremio; allows you to run addons that don't work with the regular Stremio
...
* [Torrentio](https://github.com/TheBeastLT/torrentio-scraper) ⭐ 1,320 | 🐛 78 | 🌐 JavaScript | 📅 2026-09-15: Torrent and Debrid addon with multiple sources (YTS, EZTV, RARBG, 1337x, ThePirateBay, KickassTorrents, HorribleSubs) and support for multiple debrid services (RealDebrid, AllDebrid, Premiumize, Put.io, DebridLink)
...
* [Deflix](https://github.com/doingodswork/deflix-stremio) ⭐ 194 | 🐛 21 | 🌐 Go | 📅 2023-11-19: Debrid addon with multiple sources (YTS, The Pirate Bay, RARBG, 1337x and ibit) and support for multiple debrid services (RealDebrid, AllDebrid, Premiumize), written in Go
...
* [ThePirateBay+](https://github.com/TheBeastLT/stremio-thepiratebay-plus) ⭐ 42 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-10: Torrent addon for The Pirate Bay
...
* [Official addon SDK](https://github.com/Stremio/stremio-addon-sdk) ⭐ 1,361 | 🐛 80 | 🌐 JavaScript | 📅 2026-04-08
...
* [Node.js Express Addon Example Using User Data](https://github.com/Stremio/stremio-addon-sdk/blob/master/docs/advanced.md) ⭐ 1,361 | 🐛 80 | 🌐 JavaScript | 📅 2026-04-08
...
* [Node.js Express Addon Example & Tutorial](https://github.com/Stremio/addon-helloworld-express) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2019-02-19
